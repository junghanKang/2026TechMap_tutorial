# SafeDial 007o · GitHub Pages 배포

이 저장소는 SafeDial 007o의 공개 배포 snapshot을 자체적으로 빌드해 GitHub Pages에 게시합니다.
...
- 완성 프로젝트 ZIP: https://junghankang.github.io/2026TechMap_tutorial/downloads/SafeDial-Tutorial-007o.zip
- `/`와 `/tutorials/`도 위 튜토리얼로 이동합니다.

## 배포 기준

- snapshot: `SafeDial-007o`
- source repository: `junghanKang/spatial-lab`
- source path: `Sketches/007o-spatial-depth-dial-tutorial-media-karl`
- source commit: `999a014eaaaf12220b3d09458be8df6ad5891223`
- expected ZIP SHA-256: `502fbeee09df89d273e7425e1f845ae08fc66e12d1db1e3f297d21a31ef42b2e`
